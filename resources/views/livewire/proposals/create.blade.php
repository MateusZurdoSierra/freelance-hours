<div><button class="bg-[#5354FD] text-white font-bold tracking-wide uppercase px-8 py-3 rounded-[4px]
            ...
            <div class="flex gap-4">
                ...
                <div class="w-1/3 gap-2 flex flex-col">
                    ...
                    <div class="flex" x-data="{ count: @entangle('hours') }">
                        ...
                        <input x-model="count" wire:model="hours" type="number" class="bg-[#1E1E2C] text-white py-2 pl-3 w-[40px] font-bold focus:outline-none focus:ring-0 border border-[#1E1E2C] focus:ring-blue-500" />
                        <button type="button" class="bg-[#1E1E2C] hover:bg-[#313145] transition duration-300 ease-in-out text-[#C3C3D1] py-2 px-3 text-3xl" @click="count++">+</button>
                    </div>
